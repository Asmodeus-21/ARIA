        ...
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-5 relative z-50">
            <button
              ...
              className="relative cursor-pointer px-8 py-4 text-lg font-bold text-white rounded-full shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transform hover:scale-105 transition-all duration-300 btn-shimmer pointer-events-auto"
            >
              Get Started
            </button>
            <button
              onClick={onWatchDemo}
              className="relative cursor-pointer group px-8 py-4 text-lg font-bold text-gray-700 bg-white/90 backdrop-blur-md rounded-full shadow-lg border border-white/50 hover:bg-white transform hover:scale-105 transition-all duration-300 flex items-center gap-3 pointer-events-auto"
            >
